...
debut, fin = 1980, 2120
m = ModeleGouv(1980,2120,1.3,False)
...
c = CarrierePrive(m, # le modèle
                  ...
                  "SMIC",                         # ... SMIC
                  [1.0, (30, 0.6), (40, 1.)]      # temps plein au début, passage à 60% à 30 ans, retour à 100% à 40 ans  (temps plein: [1.0])
                  )

a = AnalyseCarriere(c)
print(c.nom_metier)
a.affiche_carriere() # sortie texte d'un tableau récapitulatif de la carrière 
a.affiche_pension_macron()
print("\n")
